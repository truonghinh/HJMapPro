package gov.vn.hcmgis.projects;
...
public class Quan8Functions
{

    private static final int DEFAULT_COLUMN_PADDING = 5;
    public String vMa_Quan;
    public static IGeometry poly;
    public static double XXInternet = 0.0;
    public static double YYInternet = 0.0;
    public static double XXKS = 0.0;
    public static double YYKS = 0.0;
    public static double XXP1 = 0.0;
    public static double YYP1 = 0.0;
    public static double XXP2 = 0.0;
    public static double YYP2 = 0.0;
    public static double XXKaraoke = 0.0;
    public static double YYKaraoke= 0.0;
    public static double XXKTVHXH = 0.0;
    public static double YYKTVHXH = 0.0;
    public  static String[][] quanfilterYCHT,quanfilterPTD,quanfilterTIAX = null;
    public  static int countquanfilterYCHT, selectedquanYCHT,countquanfilterPTD, selectedquanPTD,countquanfilterTIAX, selectedquanTIAX;
    
    public  static String[][] DNCopy = null;
    public  static int countDNcopy, selectedDNCopy; 
    /*
