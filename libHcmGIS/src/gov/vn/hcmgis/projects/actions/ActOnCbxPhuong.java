 ...
 *
 */
public class ActOnCbxPhuong implements Action {
	
	private ILocationUpdateView _hook;
	
	public ActOnCbxPhuong()
	{
		this(null);
	}
	
	public ActOnCbxPhuong(ILocationUpdateView hook)
	{
		_hook=hook;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		_hook.ReadyLoadDuongTrongPhuong(cbx.getSelectedItem());
		_hook.ReadyLoadKtvhxhTrongPhuong(cbx.getSelectedItem());
	}
