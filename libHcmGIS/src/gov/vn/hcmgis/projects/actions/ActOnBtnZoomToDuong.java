 ...
 *
 */
public class ActOnBtnZoomToDuong implements Action {

	private ILocationUpdateView _hook;
	
	public ActOnBtnZoomToDuong()
	{
		this(null);
	}
	
	public ActOnBtnZoomToDuong(ILocationUpdateView hook)
	{
		_hook=hook;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		_hook.ReadyZoomToDuong(_hook.GetCbxPhuongSelectedItem(), _hook.GetCbxDuongSelectedItem());
	}
