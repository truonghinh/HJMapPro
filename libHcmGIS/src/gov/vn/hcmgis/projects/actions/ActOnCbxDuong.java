 ...
 *
 */
public class ActOnCbxDuong implements Action {

	private ILocationUpdateView _hook;
	
	public ActOnCbxDuong()
	{
		this(null);
	}
	
	public ActOnCbxDuong(ILocationUpdateView hook)
	{
		_hook=hook;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		_hook.ReadyLoadSoNha(_hook.GetCbxPhuongSelectedItem(), _hook.GetCbxDuongSelectedItem());
		_hook.ReadyLoadGiaoLo(_hook.GetCbxPhuongSelectedItem(), _hook.GetCbxDuongSelectedItem());
	}
